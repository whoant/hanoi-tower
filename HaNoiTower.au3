...
GUICtrlSetBkColor(-1, "-2")
GUICtrlCreateLabel("Mô phỏng thuật toán đệ quy giải bài toán tháp Hà Nội" & @CRLF & "coded by Hoàng Tuân" & @CRLF & "Sử dụng lại mã nguồn này xin vui lòng dẫn nguồn tác giả", -11, 172, 818, 74, $SS_CENTER, -1)
